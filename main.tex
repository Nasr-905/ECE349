...
\begingroup
\thispagestyle{empty}
\AddToShipoutPicture*{\put(0,0){\includegraphics[scale=0.385]{./Images/banner.jpg}}} % Image background
\centering
\vspace*{5cm}
...
\include{LECTURE_1/lecture_1.tex}

% \include{LECTURE_2/lecture_2.tex}

% \include{LECTURE_3/lecture_3.tex}

% \include{LECTURE_4/lecture_4.tex}
